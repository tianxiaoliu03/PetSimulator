...
while running:
    ...
    text_feed = font.render("Feed", True, white)
    text_play = font.render("Play", True, white)
    text_sleep = font.render("Sleep", True, white)
    text_earn = font.render("Earn Coins", True, white)
    text_status = font.render("Check Status", True, white)
